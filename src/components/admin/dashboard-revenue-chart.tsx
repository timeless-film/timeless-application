...
import type { RevenueGranularity, RevenuePoint } from "@/lib/services/admin-dashboard-service";
...
export function DashboardRevenueChart({ data, granularity }: DashboardRevenueChartProps) {
